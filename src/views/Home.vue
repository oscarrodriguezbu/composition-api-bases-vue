...
export default {
  ...
  setup() {
    ...
    const changeStatus = () => {
      ...
      // ironmanIsAlive = reactive(!ironmanIsAlive) //No funciona porque está intentando cambiar una constante
    }
    ...
    return {
      ...
      changeStatus,
      changeIronman: () => {
        ironman.value.name = 'Tony Stark' //para desempacar el ref necesita el .value
